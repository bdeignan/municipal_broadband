...
*From summary statistics median level is $32565.50
*Generate dummy variable that indicates if CBSA is in high income or low income group (which doesn't change during sample)
